...
public class IndexController {
	...
	/*
	 * @RequestMapping("/welcome") public String welcome(String username){
	 * logger.info("welcome, " + username); return "index"; }
	 */
	 ...
	 * public String welcome(String username){ logger.info("welcome, " + username);
	 * return "index"; }
	 */
	...
	public String loguit(HttpSession session) {
