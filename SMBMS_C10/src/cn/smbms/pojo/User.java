...
//	@DateTimeFormat(pattern = "yyyy-MM-dd")
	...
	public String toString() {
		return "User [id=" + id + ", userCode=" + userCode + ", userName=" + userName + ", userPassword=" + userPassword
				...
				+ ", modifyBy=" + modifyBy + ", modifyDate=" + modifyDate + ", role=" + role + ", age=" + age
				+ ", workPicPath=" + workPicPath + ", userRoleName=" + userRoleName + ", idPicPath=" + idPicPath + "]";
	}
}
